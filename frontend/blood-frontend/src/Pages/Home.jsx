                ...
                <Alert variant="green" className="w-100">
                  ...
                  >
                    <h6 className="xxxxlarge mb-0 text-dark">
                      Get Emergency Blood Requests Fulfilled with Blood Nepal{" "}
                    </h6>
                    <p>
                      If you require blood in an emergency, Blood Nepal is here
                ...
                <Alert variant="green" className="w-100">
                  ...
                  >
                    <h6 className="xxxxlarge mb-1 text-dark">
                      Donate Blood and Save Lives at Live Camps with Blood
                      Nepal{" "}
                    </h6>
                    <p>
                      Discover live blood donation camps happening throughout
                      Nepal on Blood Nepal. Participate in these events to
            ...
            <Col xs={12} md={6} lg={6}>
              ...
              >
                <Alert variant="green" className="w-100">
                  ...
                  >
                    <h6 className="xxxxlarge mb-0 text-dark">
                      Join Blood Nepal's Blood Donor Network Today{" "}
                    </h6>
                    <p>
                      Join Blood Nepal's network of blood donors by registering
                ...
                <Alert variant="green" className="w-100">
                  ...
                  >
                    ...
                    <p>
                      ...
                      feedback to Blood Nepal. Your valuable insights will help
